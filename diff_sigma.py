...
sigma = [10 ** -6, 10 ** -5.5, 10 ** -5, 10 ** -4.5, 10 ** -4, 10 ** -3.5]
...
plt.xticks(np.arange(-30, -4, 5), family='Times New Roman', fontsize=15)
plt.yticks(np.arange(2, 9, 1), family='Times New Roman', fontsize=15)
...
# plt.savefig("D:/python_code/access/results/compare_sigma.pdf")
