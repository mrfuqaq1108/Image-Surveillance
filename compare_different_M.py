...
def diff_M(M):
    ...
    return min_Task_value / M, local_value/M, edge_value/M
...
plt.plot(x, our_proposed, color='r', label="IJCS", linewidth=2)
plt.plot(x, local, color='g', label="GLCS", linewidth=2)
plt.plot(x, edge, color='c', label="GECS", linewidth=2)
...
# plt.savefig("D:/python_code/access/results/compare_M.pdf")
