...
def diff_B(B_times):
    ...
    B = 10*B_times  # total bandwidth = 1500 MHz
    acc_threshold = 0.85  # //////////////////
    a1 = 0.04592165
    a2 = 0.97662984
    c1 = 10.33466385
...
plt.xlabel("Bandwidth (MHz)", font1, labelpad=10)
...
plt.xticks(np.arange(10, 151, 20), family='Times New Roman', fontsize=15)
plt.yticks(np.arange(2.4, 3.5, 0.2), family='Times New Roman', fontsize=15)
...
# plt.savefig("D:/python_code/access/results/compare_B.pdf")
